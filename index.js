...
function describeTemperature(f) {
  let describeTemperature = f;
  
  if(describeTemperature < 32) {
    return 'very cold'
  }
  else if(describeTemperature < 64) {
    return "cold"
  } 
  else if(describeTemperature < 86) { 
    return "warm"
  }
  else if(describeTemperature < 100) {
    return "hot"
  }
  else if(describeTemperature >= 100) {
    return 'very hot'
